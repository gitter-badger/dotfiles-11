...
# Enable Notification Center and ADD the menu bar icon
...
defaults write NSGlobalDomain com.apple.springing.delay -int 1
...
# Bottom left screen corner → Start launch pad
